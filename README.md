...
Business & computer science at TUM, focused on applied AI. I design and ship software end to end using agentic AI workflows on AWS Bedrock, Azure AI Foundry and Google Vertex AI.
...
- [flipper-nrf-spectrum](https://github.com/laurinlibossek/flipper-nrf-spectrum): NRF24 spectrum analyzer for the Flipper Zero (C)

**Stack:** Python · Java · JavaScript · Swift · C/C++ · SQL · R · AWS · Azure · GCP · Git

[LinkedIn](https://www.linkedin.com/in/laurinlibossek)
